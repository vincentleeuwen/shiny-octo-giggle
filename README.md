...
I use query string parameters to generate previews of the white label webshop. In the real world, I would much prefer to use a backend service for this. This shouldn’t be hard to implement, as the <Preview /> component has been wrapped by a container component to parse the query params.
